    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex items-start gap-8">
        <div class="max-w-6xl mx-auto flex">
          ...
          <div class="w-1/2 p-8">
            <h2 class="text-3xl font-bold mb-6">CLB Khởi Nghiệp</h2>
            <div class="flex mb-4">
              <div class="mr-8">
          ...
          <div class="w-1/2 grid grid-cols-3 gap-4 p-4">
            <img v-for="n in 6" :key="n" src="../../assets/1.webp" class="rounded-lg object-cover" alt="Club Image" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
          ...
          <p class="text-gray-600 mb-8">
            Với tầm nhìn phát triển CLB trở thành một CLB Khời nghiệp lớn mạnh cả trong và ngoài phạm vi trường
            đại học...
          </p>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-white rounded-lg overflow-hidden shadow-lg">
            <img src="../../assets/1.webp" alt="Event" class="w-full h-48 object-cover" />
            <div class="p-6">
